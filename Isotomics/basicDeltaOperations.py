...
#Z=Cl: ISOTOPE-ABUNDANCE VARIATIONS OF SELECTED ELEMENTS, IUPAC technical report, 2002, Copeland et al. 
STD_Rs = {"H": 0.00015576, "C": 0.011180, "N": 0.003676, "17O": 0.0003799, "18O": 0.0020052,
         "33S":0.007877,"34S":0.0441626,"36S":0.000105274,'Cl':0.31962681}
...
def deltaToConcentration(atomIdentity,delta):
    ...
    if atomIdentity == 'Cl':
        ratio = (delta/1000 + 1) * STD_Rs['Cl']
        concentrationSub = ratio/(1+ratio)

        return (1-concentrationSub,0,concentrationSub,0)
...
def ratioToDelta(atomIdentity, ratio):
    ...
    elif atomIdentity == 'Cl' or atomIdentity == '37Cl':
        delta = (ratio/STD_Rs['Cl']-1)*1000
...
def deltaToRatio(atomIdentity, delta):
    return concentrationToM1Ratio(deltaToConcentration(atomIdentity, delta))
